...
import { setAccountsSearchText, openNewAccountDialog } from './store/accountsSlice';
    ...
    <div className="flex flex-1 items-center justify-between p-4 sm:p-24">
        ...
        <ThemeProvider theme={mainTheme}>
          ...
          >
            ...
            <Input
              ...
              onChange={(ev) => dispatch(setAccountsSearchText(ev))}
            />
          </Paper>
        </ThemeProvider>
      </div>
      ...
      >
        <Button
          variant="contained"
          color="secondary"
          onClick={(ev) => dispatch(openNewAccountDialog())}
        >
          <span className="hidden sm:flex">Add New Account</span>
